...
\centering
\includegraphics[width=0.9\linewidth]{D:/Uni/Projekte/02-Intensification/AmpCanE/images/VariantPdFunction.png}
\caption{\tiny \% Variants in CanE.}
\label{fig:VariantAgeCanE}
\end{minipage}
\begin{minipage}{0.55\textwidth}
\centering
\includegraphics[width=0.9\linewidth]{D:/Uni/Projekte/02-Intensification/AmpCanE/images/BorutaAmpCanE.png}
\caption{\tiny Boruta results for really in CanE.}
\label{fig:BorutaCanE}
\end{minipage}\\
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[width=0.6\linewidth]{D:/Uni/Projekte/02-Intensification/AmpCanE/images/PredictedFrequencyAgeGlmSmooth.png}
\caption{\tiny Prob. really in CanE by adj. freq.}
\label{fig:ReallyCanEFrequency}
\end{minipage}
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[width=0.6\linewidth]{D:/Uni/Projekte/02-Intensification/AmpCanE/images/PredictedFrequencyAge.png}
...
\begin{center}
\begin{figure}
%\includegraphics[width=.55\textwidth]{D:/Uni/Projekte/02-Intensification/AmpAusE/images/mixedmodel.png}
\begin{footnotesize}
